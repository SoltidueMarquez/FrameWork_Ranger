...
using FrameWork_Ranger.ResourceManagement.Samples;
...
namespace FrameWork_Ranger.ResourceManagement.Samples.Editor
{
    /// <summary>
    ...
    internal static class ResourceManagementSampleAssetBuilder
    {
        internal const string RootDirectory =
            "Assets/Plugins/FrameWork_Ranger/BaseModules/ResourceManagement/Samples";
        ...
        internal const string ResourcesPrefabPath =
            RootDirectory + "/Runtime/Resources/FrameWork_Ranger/ResourceManagement/ResourcesSamplePrefab.prefab";
        internal const string SampleScenePath = RootDirectory + "/Scenes/ResourceManagementSample.unity";
        internal const string AddressablesGroupName = "FrameWork_Ranger ResourceManagement Samples";
        ...
        private static void Build(bool confirmOpenSceneSave)
        {
            ...
            try
            {
                ...
                Debug.Log("[FrameWork_Ranger] Resource Management 双后端验收资产已刷新到模块示例场景。" );
            }
            finally
            {
        ...
        private static void EnsureAllFolders()
        {
            ...
            EnsureFolder(RootDirectory + "/Runtime/Resources/FrameWork_Ranger/ResourceManagement");
        }
