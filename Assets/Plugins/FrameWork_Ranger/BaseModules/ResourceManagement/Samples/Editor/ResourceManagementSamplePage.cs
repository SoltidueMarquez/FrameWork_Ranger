...
namespace FrameWork_Ranger.ResourceManagement.Samples.Editor
{
    ...
    public sealed class ResourceManagementSamplePage : FrameworkCenterPage
    {
        ...
        public override string HelpDocumentPath =>
            "Assets/Plugins/FrameWork_Ranger/Docs/03_Architecture/FoundationModules/ResourceManagement/README.md";
        ...
        public override void OnGUI(FrameworkCenterPageContext context)
        {
            ...
            {
                if (GUILayout.Button("打开资源模块验收场景", GUILayout.Height(34f)))
                {
                    OpenScene();
                }
            }
            ...
            DrawStep("5", "重新加载资源模块示例场景，确认 Global ResourceModule 保持同一运行时实例。" );
        }
        ...
        private static void OpenScene()
        {
            ...
            EditorSceneManager.OpenScene(ResourceManagementSampleAssetBuilder.SampleScenePath, OpenSceneMode.Single);
        }
