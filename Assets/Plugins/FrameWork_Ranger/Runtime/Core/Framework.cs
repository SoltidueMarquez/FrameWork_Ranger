...
{
    /// <summary>
    /// FrameWork_Ranger 面向业务代码的静态只读门面。它提供状态、就绪等待和按具体类型查询，
    ...
    public static class Framework
    {
        ...
        internal static UniTask DetachSceneAsync(ulong sceneHandle)
        {
        ...
        private static FrameworkRuntime EnsureRuntime()
        {
            ...
            var hostObject = new GameObject("[FrameWork_Ranger]");
