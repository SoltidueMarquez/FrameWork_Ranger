...
- 当前 `MainLoaderBase` 已基本按参考框架移植至 `[Assets/Plugins/Framework_WWJ/Main/Module/Loader/MainLoaderBase.cs](Assets/Plugins/Framework_WWJ/Main/Module/Loader/MainLoaderBase.cs)`，但仍依赖：
...
- **配置层（最小实现）**：
  - 在 `[Assets/Plugins/Framework_WWJ/Main/Module/Config/ModuleCfg.cs](Assets/Plugins/Framework_WWJ/Main/Module/Config/ModuleCfg.cs)` 上，确保：
