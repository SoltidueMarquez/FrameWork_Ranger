...
> 配置日期：2026-08-22<br>
> 工程：`D:\unityhub\UnityProjects\FrameWork\FrameWork_WWJ`<br>
...
```powershell
pwsh -File .\Tools\UnityCli.ps1 -Task TestEditMode `
  -AssemblyNames 'Framework_WWJ.Tests.EditMode'

pwsh -File .\Tools\UnityCli.ps1 -Task TestPlayMode `
  -TestFilter 'Framework_WWJ.*Resource*'
...
# 默认输出 Builds\UnityCli\Framework_WWJ.exe
