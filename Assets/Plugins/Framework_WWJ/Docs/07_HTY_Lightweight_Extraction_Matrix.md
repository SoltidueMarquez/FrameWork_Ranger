...
> 状态：候选分析，不是 Framework_WWJ 最终架构。<br>
...
| HTY 机制 | 解决的问题 | Framework_WWJ 候选方向 | 状态 |
| --- | --- | --- | --- |
...
某个 HTY 机制只有同时满足以下条件，才可以进入 Framework_WWJ 的阶段设计：
...
待决策项目统一收录在 [重建设计待办](./09_Rebuild_Decision_Backlog.md)。
