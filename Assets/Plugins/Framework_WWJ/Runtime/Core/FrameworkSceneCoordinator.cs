...
namespace Framework_WWJ
{
    ...
    internal sealed class FrameworkSceneCoordinator : IDisposable
    {
        ...
        private readonly Dictionary<int, CancellationTokenSource> m_sceneCancellations =
            new Dictionary<int, CancellationTokenSource>();

        private int m_activeSceneHandle;
        ...
        internal UniTask DeactivateSceneAsync(int sceneHandle)
        {
